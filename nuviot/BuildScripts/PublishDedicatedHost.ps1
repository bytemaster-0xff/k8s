...
$publishDir = "./PublishedDedicatedHosts"
if(Test-Path $publishDir){
    Remove-Item -Recurse -Force $publishDir
}

$out = git clone https://github.com/bytemaster-0xff/PublishedDedicatedHosts $publishDir 2>$1 
if ($?) {
...
dotnet publish  ./io.IoTEngine/src/LagoVista.IoT.Runtime.Dedicated.Host/LagoVista.IoT.Runtime.Dedicated.Host.csproj -c Release -o "$solutionPath\$publishDir\publish"
...
$tag = "slsys.dedicatedhost.$version"
$tagMsg = """DedicatedHost Host Version $version"""
